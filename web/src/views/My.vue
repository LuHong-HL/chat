<template>
  <div>
    ...
    <van-cell-group class="my-header pb-2 pt-2">
      <van-cell class="cell-container d-flex ai-center jc-between fs-lg mt-1 mb-1">
        ...
        <template v-slot:title>
          <span class="cell-title pl-1 fs-xxl text-dark flex-grow-1">我是小小明鸭</span>
        </template>
        <template v-slot:label>
          <div class="d-flex">
            ...
            <div class="d-flex">
              ...
              <van-icon
                class-prefix="iconfont iconarrow-right-copy-copy-copy"
                size=".5rem"
                color="#e8e8e8"
              />
            </div>
    ...
    <van-cell-group class="my-container">
      <van-cell class="cell-container d-flex ai-center jc-between fs-lg">
        <template v-slot:icon>
          <van-icon class-prefix="iconfont iconshezhi" size=".586667rem" color="#2e92f0" />
        </template>
        <template v-slot:title>
          <span class="cell-title pl-1 fs-lg text-dark flex-grow-1">设置</span>
        </template>
...
.my-header {
  .van-cell__label {
    margin-top: map-get($spacing-sizes, "1") * $spacing-base-size;
  }
}
</style>